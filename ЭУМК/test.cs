    ...
    public partial class test : Form
    {
        ...
        void НачалоТеста()
        {
            ...
            try
            {
                ...
                System.IO.Directory.GetCurrentDirectory() + yy, Кодировка);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (button1.Text == "Завершить")
            {
                ...
                label1.Text = String.Format("Тестирование завершено.\n" +
                    ...
                    "Оценка в десятибальной системе: {2:F2}.", ПравилОтветов,
                    СчетВопросов, (ПравилОтветов * 10.0F) / СчетВопросов);
                // 10F - это максимальная оценка
